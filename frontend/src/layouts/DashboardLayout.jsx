...
const DashboardLayout = () => {
  ...
  const isShopPage = path.startsWith('/shop') || path.startsWith('/checkout') || path.startsWith('/order-success') || path.startsWith('/about') || path.startsWith('/careers') || path.startsWith('/press') || path.startsWith('/sustainability') || path.startsWith('/help-center') || path.startsWith('/shipping') || path.startsWith('/returns') || path.startsWith('/contact') || path.startsWith('/privacy') || path.startsWith('/terms');
