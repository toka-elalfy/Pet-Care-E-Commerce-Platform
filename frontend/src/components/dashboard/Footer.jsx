    ...
    <div className="max-w-[1280px] mx-auto px-6 lg:px-0 flex flex-col gap-12">
          ...
          {[
            {
              title: 'Shop', links: [
                ...
                { name: 'Health', path: '/shop?category=health' },
            ...
            <div key={col.title} className="flex flex-col gap-4">
              ...
              {col.links.map(l => (
                <Link key={l.name} to={l.path} className="font-manrope text-[14px] text-white/70 hover:text-white transition-colors">{l.name}</Link>
              ))}
            </div>
          ))}
        </div>
      ...
      <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-5">
          <Link to="/privacy" className="font-manrope text-[16px] text-white/60 hover:text-white transition-colors">Privacy</Link>
          <Link to="/terms" className="font-manrope text-[16px] text-white/60 hover:text-white transition-colors">Terms</Link>
          <Link to="/cookies" className="font-manrope text-[16px] text-white/60 hover:text-white transition-colors">Cookies</Link>
        </div>
      </div>
    </div>
  </footer>
