          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col gap-3 lg:gap-[15px]">
              {[
                ...
                <li key={item.label}>
                  <Link to={item.path} className="font-manrope font-medium text-[14px] text-white/70 hover:text-white transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
      ...
      <div className="w-full border-t border-white/10 flex justify-center">
        <div className="w-full max-w-[1280px] h-auto lg:h-[65px] px-4 sm:px-6 xl:px-[24px] flex flex-col-reverse lg:flex-row items-center justify-between py-6 lg:py-0 gap-4 lg:gap-0">
          ...
          {[
            ...
            <Link key={item.label} to={item.path} className="font-manrope font-medium text-[12px] lg:text-[13px] text-white/60 hover:text-white transition-colors">
              {item.label}
            </Link>
          ))}
        </div>
