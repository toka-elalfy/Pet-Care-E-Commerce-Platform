...
// ─── Initial form state (clean separation from UI) ───────────────────────────
const INITIAL_FORM = {
  name: '',
  animalType: 'Dog',
  breed: '',
...
const AddNewPet = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: POST /api/pets  →  { ...form }
    console.log('New pet submitted:', form);
    navigate('/my-pets');
  };
    ...
    <main className="flex-1 flex flex-col gap-6 animate-[fadeIn_0.5s_ease-out]">
      ...
      <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
        <div className="flex flex-col gap-1">
          <h1 className="font-sora font-semibold text-[24px] lg:text-[28px] text-[#1f2937] leading-tight">Add a new pet</h1>
          <p className="font-manrope text-[13px] lg:text-[14px] text-[#6b7280] leading-[21px]">
            Pet profile data powers personalization across the platform.
          </p>
        </div>
        <button
